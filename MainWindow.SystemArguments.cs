...
// =======================================================================
...

    {
...

        {
            ...
            {
                MessageBox.Show($"Lá»—i khi má»Ÿ Neat Download Manager: {ex.Message}", "Neat Download Manager", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private async Task InstallMemReductAsync()
        {
            try
            {
                UpdateStatus("Äang táº£i MemReduct...", "Cyan");

                string memReductSetupName = "memreduct-3.5.2-setup.exe";
                string memReductPath = Path.Combine(GetGMTPCFolder(), memReductSetupName);
                ...
                UpdateStatus("Äang cÃ i Ä‘áº·t MemReduct (silent)...", "Yellow");
                ...
                {
                    await Task.Run(() => process.WaitForExit());
                    UpdateStatus("CÃ i Ä‘áº·t MemReduct hoÃ n táº¥t!", "Green");
                }
            ...
            {
                UpdateStatus($"Lá»—i khi cÃ i Ä‘áº·t MemReduct: {ex.Message}", "Red");
            }
        }
